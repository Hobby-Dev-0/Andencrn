...
if($msg == "/start" or $msg == "/start@Andencentobot"){
Alvi('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"***Hey  👋 $first_name,
...
'inline_keyboard' => [
[['text' => "SUPPORT",'url' => "https://telegram.me/AndencentoSupport"],['text' => "CREATOR", 'url' => "https://telegram.me/Andencento"]],
[['text' => "ADD ME", 'url' => "https://telegram.me/$BOT_USERNAME?startgroup=False"],['text' => "Repo", 'url' => "nop"]], 
]])
]);
}
?>
