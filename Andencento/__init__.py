...
if ENV:
    ...
    NO_LOAD = os.environ.get("NO_LOAD", "lol").split()
    ...
    from Andencento.config import Development as Config
...
# Don't Remove my ID from DEV and SUDO list..It Took many months to set up a bot like this..I have added many features in this bot ..by @AndencentoSupport     
...
telethn = TelegramClient("Andencento", api_id, api_hash)
...
from Andencento.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
