...
from Andencento import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL, telethn
from Andencento.modules import ALL_MODULES
from Andencento.modules.helper_funcs.chat_status import is_user_admin
from Andencento.modules.helper_funcs.misc import paginate_modules
from Andencento.modules.connection import connected
from Andencento.modules.connection import connect_button


PM_START_TEXT = """
_Hello_ *{}*
_My name is_ *{}*\n_A Powerful Telegram ProBot to Manage Your Groups,feel free to add to your groups!!_
_Maintained by_ [Team Andencento](https://telegram.me/Andencento)
"""
...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/InternetAmethyst/Andencrn)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/InternetAmethyst/Andencrn.git)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/ac32724650ef92663fbd1.png"
else:
  img = START_IMG    
    
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Andencento.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/Andencento")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/Andencento")]]))
        return
...
def main():
    ...
    if WEBHOOK:
        ...
        LOGGER.info("Andencento Management bot running...")
