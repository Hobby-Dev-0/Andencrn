...
import Andencento.modules.sql.global_mutes_sql as sql
from Andencento import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS, SUPPORT_USERS, STRICT_GMUTE, GBAN_LOGS
